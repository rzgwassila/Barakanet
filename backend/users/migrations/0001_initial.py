# Generated by Django 5.1.7 on 2025-03-15 15:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='users.charity')),
            ],
        ),
        migrations.CreateModel(
            name='CharityImage',
            fields=[
                ...
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('charity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='users.charity')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.AddField(
            model_name='charity',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='charity_profile', to='users.user'),
        ),
        migrations.CreateModel(
            name='Volunteer',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='volunteer_profile', to='users.user')),
            ],
        ),
    ]
